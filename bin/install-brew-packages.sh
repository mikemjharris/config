...
brew update
brew install nginx --with-passenger passenger wget tree openssh redis docker openssl ffmpeg  imagemagick htop postgres tmux vim jq rbenv the_silver_searcher ack nvm fzf mysql v8 elasticsearch telnet mosh zoxide
